...
public class SolicitacaoController {
	...
	private AnchorPane novaSolicit;
	...
	void initialize() throws IOException {
		...
		novaSolicit = FXMLLoader.load(getClass().getResource("../view/CadastroSolicitacoes.fxml"));
	}
...
//		refreshTable();
		MDIWindow cadMDI = new MDIWindow("mdiID", new ImageView("logotipoSCESVI.png"), "Cadastro " + i, novaSolicit);
		canvas.addMDIWindow(cadMDI);
		i++;
